    ...
    >
      ...
      >
        ...
        >
          ...
          <div className="bg-[#161b22] p-6 rounded-xl shadow-sm">
            <h3 className="text-2xl font-semibold text-[#f6f5f3] mb-4 flex items-center">
              <span className="mr-2">   <FiGlobe className="text-xl" /></span> Location & Availability
            </h3>

            <div className="space-y-3 text-[#f6f5f3]">
              <p className="flex items-center gap-2">
                <FiMapPin className="text-[#f6f5f3]" />
                <span>Based in Pokhara, Nepal</span>
              </p>
              <p className="flex items-center gap-2">
                <FiMail className="text-[#f6f5f3]" />
                <a href="rokaraaz@gmail.com" className="underline hover:text-[#f6f5f3]">
                  rokaraaz@gmail.com
                </a>
              </p>
              <p className="flex items-center gap-2">
                <FiPhone className="text-[#f6f5f3]" />
                <span>+977-9847632326</span>
              </p>
            </div>
            ...
            <div className="mt-6">
              ...
              <p className="text-gray-400">
                I also enjoy designing UI and playing games during my free time. I’m always curious and excited to learn something new!
              </p>
            </div>
          </div>
        </motion.div>
